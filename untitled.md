Черновик правки https://github.com/eucariot/SDSM/blob/master/4.-stp/02-rstp.md
...
| List3 | List4 |
| **Механизмы работы** |  |
| List5 | Использует процесс proposal and agreement \(предложение и соглашение\) |
...
| Если некорневой свич не получает hello-пакеты от корневого в течение Max Age, он начинает новые выборы | Начинает действовать, если не получает BPDU в течение 3 hello-интервалов |
| List6 | Быстрый переход к Forwarding для p2p и Edge-портов |
